...
public class PolicyOwner {
    ...
    @OneToMany(mappedBy = "policyOwnerByPolicyOwnerId")
    private Collection<InsuranceCard> insuranceCardsById;
    ...
    public Collection<Entity.InsuranceCard> getInsuranceCardsById() {
        return insuranceCardsById;
    }

    public void setInsuranceCardsById(Collection<Entity.InsuranceCard> insuranceCardsById) {
        this.insuranceCardsById = insuranceCardsById;
    }
}
